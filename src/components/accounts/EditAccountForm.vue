     ...
     <div class="p-field p-col-12 p-md-3">
                    ...
                    v-model="account.name"
                     required="true"
                      :class="{
                      'p-invalid':
                        (submitted && v$.account.name.$invalid) ||
                        errors.name,
                    }"
                  />
                  <small
                    ...
                    >{{
                      v$.account.name.required.$message.replace(
                        "Value",
                        "Name"
                      )
                    }}</small
                  ...
                  <InputNumber
                    ...
                    :class="{
                      'p-invalid':
                        (submitted && v$.account.amount.$invalid) ||
                        errors.amount,
                    }"
                  />
                  <small
                    ...
                    >{{
                      v$.account.amount.required.$message.replace(
                        "Value",
                        "Amount"
                      )
                    }}</small
                ...
                <div class="p-field p-col-12 p-md-1">
                  ...
                  <InputNumber
                    ...
                    :class="{
                      'p-invalid':
                        (submitted && v$.account.order.$invalid) ||
                        errors.amount,
                    }"
                  />
                  <small
                    ...
                    >{{
                      v$.account.order.required.$message.replace(
                        "Value",
                        "order"
                      )
                    }}</small
     ...
     <div class="p-grid">
                 ...
                 <div class="p-field p-col-12 p-md-3">
                  ...
                  <Dropdown
                    ...
                    :class="{
                      'p-invalid':
                        (submitted && v$.account.type.$invalid) ||
                        errors.type,
                    }"
                  />
                  <small
                    ...
                    >{{
                      v$.account.type.required.$message.replace(
                        "Value",
                        "Currency"
                      )
                    }}</small
                ...
                <div class="p-field p-col-12 p-md-3">
                 ...
                 <div class="p-field p-col-12 p-md-1">
                  ...
                  <small
                    ...
                    >{{
                      v$.account.isActive.required.$message.replace(
                        "Value",
                        "Active"
                      )
                    }}</small
        ...
        <div class="p-grid">
          <div class="p-field p-col-12">
                  ...
                  <Textarea
                    ...
                    :class="{
                      'p-invalid':
                        (submitted && v$.account.comment.$invalid) ||
                        errors.comment,
                    }"
                  />
                  <small
                    ...
                    >{{
                      v$.account.comment.required.$message.replace(
                        "Value",
                        "comment"
                      )
                    }}</small
...
export default {
   ...
   validations() {
    return {
      account: {
        ...
        parentAccountId: {required: requiredIf(() => this.account.type === 2), notSameAccount: not(sameAs(this.account.id)), },
        comment:{},
      }
    }
   },
  data() {
    return {
      ...
      accountGroups: [],
      currencies: [],
      accountTypes: [{name: 'Account', id: 0},{name: 'Wallet', id: 1},{name: 'Card', id: 2},],
      errors:[],
      submitted: false,
    }
  },
    ...
    saveAccount() {
      ...
      const _self = this;
        accountsService
          ...
          .then(() => {
              this.$store.dispatch('alert/success', { title: 'Success!', message: 'Account saved' }, { root: true });
          })
          .catch((data) => {
            _self.errors = data;
          });
