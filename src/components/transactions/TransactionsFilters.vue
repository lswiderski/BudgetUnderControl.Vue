        ...
        <div class="card toolbar-demo">
            ...
            <div class="p-fluid p-formgrid p-grid">
                <div class="p-field p-col-12 p-md-2">
                    ...
                    <div>
                    <Calendar v-model="dateFrom" :showIcon="true" id="dateFrom" :yearNavigator="true" yearRange="2000:2030" :monthNavigator="true" />
                    </div>
				</div>
                <div class="p-field p-col-12 p-md-2">
					<label for="dateTo">To</label>
                    <div>
                    <Calendar v-model="dateTo" :showIcon="true" id="dateTo" :yearNavigator="true" yearRange="2000:2030" :monthNavigator="true" />
                    </div>
                </div>
                 ...
                 <div class="p-field p-col-12 p-md-4">
                    ...
                    <div>
                    <MultiSelect v-model="accountsIds" :options="accounts"
                    optionLabel="name"
                    optionValue="id"
                 ...
                 <div class="p-field p-col-12 p-md-4">
                    ...
                    <div>
                    <MultiSelect v-model="categoryIds" :options="categories"
                    optionLabel="name"
                    optionValue="id"
                    placeholder="include all if empty"
                    id="categories"
                   ...
                   <div class="p-field p-col-12 p-md-4">
                    ...
                    <div>
                    <MultiSelect v-model="tagIds" :options="tags"
                    optionLabel="name"
                    optionValue="id"
                    placeholder="include all if empty"
                    id="tags"
